...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = Colors.orange,
    Color flashingCircleBrightColor = Colors.orangeAccent,
    TextStyle incomingChatLinkTitleStyle = const TextStyle(color: Colors.black),
    ...
    Color backArrowColor = Colors.orange,
    Color backgroundColor = const Color(0xffffffff),
    Color replyDialogColor = Colors.amberAccent,
    Color linkPreviewOutgoingChatColor = Colors.amberAccent,
    Color linkPreviewIncomingChatColor = const Color(0xFFEEEEEE),
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = Colors.orange,
    ...
    Color outgoingChatBubbleColor = Colors.orange,
    Color inComingChatBubbleColor = Colors.black12,
    Color inComingChatBubbleTextColor = Colors.black,
    Color repliedMessageColor = Colors.orangeAccent,
    Color closeIconColor = Colors.black,
    Color shareIconBackgroundColor = const Color(0xFFE0E0E0),
    Color sendButtonColor = Colors.orange,
    ...
    Color verticalBarColor = Colors.orange,
